...
return new class () extends Migration {
    ...
    {
        Schema::create('pbx_services_did', function (Blueprint $table) {
            $table->increments('id');
            // columns fk
            ...
            $table->unsignedInteger('pbx_profile_did_id')->nullable();
            /*
                        ...
                        $table->foreign('pbx_profile_did_id')->references('id')->on('profile_did')->onDelete('cascade');
            */
            $table->timestamps();
            $table->softDeletes();
        });
    ...
    {
        Schema::dropIfExists('pbx_services_did');
    }
};
