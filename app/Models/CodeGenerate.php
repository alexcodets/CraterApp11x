...
// length = Your code length
// prefix = Define your prefix. It can be a year prefix, moth, or any custom letter.
// reset_on_prefix_change = Optional, default false. If you want to reset in from 1 on prefix change.
//  Example:
