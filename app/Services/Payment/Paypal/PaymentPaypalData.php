...
class PaymentPaypalData extends PaymentDO
{
    public PaymentsPaypal $paypalPayment;
    ...
    public function getCreditCardData(): array
    {
        ...
        return [
            ...
            'email' => $paymentAccount->email ?? $this->user->email,
    ...
    public function getTransactionData($transaction): array
    {
        ...
        return [
            ...
            'email_address' => $paymentAccount->email ?? $this->user->email,
            ...
            'creator_id' => $paymentAccount->id ?? null,
