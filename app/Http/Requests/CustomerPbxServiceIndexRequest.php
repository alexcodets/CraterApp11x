...
class CustomerPbxServiceIndexRequest extends BaseApiRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'date.in' => 'The value for date must be in: created, renewal, begin'
        ];

    }
}

//date=['created', 'renewal', 'begin']
