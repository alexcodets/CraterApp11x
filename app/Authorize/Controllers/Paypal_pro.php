...
class paypal_pro
{
    ...
    public function __construct($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $PROXY_HOST, $PROXY_PORT, $IS_ONLINE = false, $USE_PROXY = false, $VERSION = '57.0')
    {
        $this->API_USERNAME = 'sb-yhprj7455872_api1.business.example.com';
        $this->API_PASSWORD = 'N6P8MUQGR6RTS9JY';
        $this->API_SIGNATURE = 'Av8LMzTJ7FmTl6QmK3GViFJ-8pmpAG.cgM.vTR2y7WTFTxsV3QwYolqy';
