...
return [
    ...
    */
    ...
    'features' => [
        ...
        'database' => [
            ...
            'slow_threshold' => env('CLOCKWORK_DATABASE_SLOW_THRESHOLD', 1000),
        ...
        'events' => [
            ...
            'ignored_events' => [
                // Crater\Events\UserRegistered::class,
                // 'user.registered'
            ],
        ],
    ...
    */
    ...
    'queue' => [
        ...
        'except' => [
            // Crater\Jobs\ExpensiveJob::class
        ],

        // List of queue jobs that should be collected, any other queue job will not be collected if not empty
        'only' => [
            // Crater\Jobs\BuggyJob::class
        ]
    ],
