    ...
    return new Promise((resolve, reject) => {
        window.axios
            ...
            .then((response) => {
                ...
                commit(types.BOOTSTRAP_DID, response.data.profileDID.data)
                commit(types.SET_TOTAL_DID, response.data.profileDID.total)
                resolve(response)
            })
            .catch((err) => {
