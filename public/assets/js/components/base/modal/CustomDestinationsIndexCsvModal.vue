    ...
    <div v-if="!banCsv">
      ...
      <div class="pt-4 pb-40 px-6">
        ...
        <div v-if="formData.type_group === 'new_group'">
          ...
          >
            <sw-input
              v-model.trim="formData.prefix_group_name"
...
export default {
  ...
  data() {
    return {
      ...
      /* category: [
        { value: 'C', text: '1 Custom' },
        { value: 'T', text: '2 Toll Free' },
        { value: 'I', text: '3 International' },
      ], */
