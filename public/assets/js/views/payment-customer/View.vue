<template>
  <base-page v-if="payment" class="xl:pl-96">
    ...
    >
      ...
      <div class="h-full pb-32 overflow-y-scroll border-l border-gray-200 border-solid sw-scroll">
        <router-link
    ...
    <div
      ...
      style="height: 75vh"
    >
      <base-loader class="flex-1 absolute" v-if="loadingPdf" :show-bg-overlay="true" />
      <iframe
        :src="`${shareableLink}`"
