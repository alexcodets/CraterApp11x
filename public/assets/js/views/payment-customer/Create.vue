        ...
        <div v-if="this.type_ach" class="w-full flex flex-wrap">
          ...
          <div class="w-full flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 mb-4 md:pr-2">
              ...
              >
                <sw-input
                  :invalid="$v.formData.num_check.$error"
...
export default {
  ...
  computed: {
    ...
    amountError() {
      ...
      if (
        ...
        console.log('no pude ser menor a cero')
  ...
  methods: {
    ...
    async loadCustomerData(params) {
      ...
      this.paypal.country_id = null
      this.paypal.state_id = null
      this.paypal.city = null
      this.paypal.phone = null
      this.paypal.zip = null
      this.paypal.address_street_1 = null
      this.paypal.address_street_2 = null
      this.paypal.country = null
      this.paypal.state = null
      this.paypal.first_name = null
      this.paypal.last_name = null
      this.paypal.company_name = null
      ...
      this.paypal.first_name = response.data.customer.first_name
      this.paypal.last_name = response.data.customer.last_name
      this.paypal.company_name = response.data.customer.company.name
      this.paypal.email = response.data.customer.email
      ...
      if (response.data.customer.billing_address) {
        ...
        this.paypal.country_id =
          response.data.customer.billing_address.country_id
        this.paypal.state_id = response.data.customer.billing_address.state_id
        this.paypal.city = response.data.customer.billing_address.city
        this.paypal.phone = response.data.customer.billing_address.phone
        this.paypal.zip = response.data.customer.billing_address.zip
        this.paypal.address_street_1 =
          response.data.customer.billing_address.address_street_1
        this.paypal.address_street_2 =
          response.data.customer.billing_address.address_street_2
        this.paypal.country =
          response.data.customer.billing_address.country.name
        this.paypal.state = response.data.customer.billing_address.state.name
    ...
    async submitPaymentData() {
      ...
      if ((this.$v.$invalid || validate.error) && this.type_ach) {
      ...
      // en caso de que sea un pago nuevo
      else {
        if (this.formData.credit_cards) {
          this.formData.credit_card = this.formData.credit_cards.value
        }
        try {
            ...
            swal({
              ...
              if (willDelete) {
                ...
                if (this.isAuthorize && !this.type_ach && !this.is_paypal) {
                  ...
                  this.authorize.credit_cards = this.formData.credit_card
                  ...
                  if (
                    res.data &&
                    res.data.transactionResponse?.cvvResultCode === 'N'
                  ) {
                  ...
                  if (
                    res.data &&
                    res.data.transactionResponse?.cvvResultCode === 'U'
                  ) {
                    this.transactionFail.description =
                  ...
                  if (
                    res.data &&
                    res.data.transactionResponse?.cvvResultCode === 'S'
                  ) {
                    this.transactionFail.description =
                ...
                //  pago sin factura con ach
                  ...
                  this.authorize.name_on_account = this.authorize.name
                  this.formData.authorize = this.authorize
          ...
          // en caso de que sea un pago con factura
            ...
            if (this.isAuthorize && !this.type_ach && !this.is_paypal) {
              ...
              if (res.data.messages?.resultCode == 'Error') {
                this.transactionFail.description =
                  res.data.messages.message[0].text
                console.log(res.data.messages.message[0].text)
    ...
    async paypalSuccess(payment_paypal_id) {
      ...
      if (response.data.success) {
        this.$router.push(`/customer/payments/${response.data.payment.id}/view`)
        window.toastr['success'](this.$t('payments.created_message'))
        this.isLoading = true
        return true
      }
