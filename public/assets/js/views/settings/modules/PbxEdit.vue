              ...
              >
                <div class="flex flex-wrap"> 
                  <div class="mb-2 md:mb-0 w-full md:w-1/2 ">
                    <sw-select
                      ...
                      :allow-empty="true"
                      :tabindex="8"
                      :placeholder="$t('settings.customization.modules.place_select_continent')"
                      class="md:mr-2 "
                ...
                <div class="mt-2 md:mt-0 w-full md:w-1/2 ">
                  <sw-select
                    ...
                    :allow-empty="true"
                    :tabindex="8"
                    :placeholder="$t('settings.customization.modules.please_select_zone')"
                    label="label"
                    class="md:ml-2"   
    ...
    async loadEditPbxServer() {
      if (this.isEdit) {
        ...
        if(response.data.pbxServer.timezone){
          ...
          let label = `${labelArr[1]} ${labelArr.length > 2 ? ' - '+labelArr[2] : ''}`
          this.timezone = {
            label: label ,
        ...
        // load cdrStatus
        this.formData.cdrStatus = response.data.pbxServer.cdr_status.map(item => item.status)
