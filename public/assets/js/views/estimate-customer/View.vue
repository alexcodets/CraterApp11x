    ...
    >
      ...
      >
        <router-link
          ...
          :to="`/customer/estimates/${estimate.id}/view`"
...
export default {
  ...
  methods: {
    ...
    async loadEstimate() {
      let response = await this.fetchViewEstimateCust(this.$route.params.id)
      if (response.data) {
