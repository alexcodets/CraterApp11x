              ...
              <div class="grid col-span-5 lg:col-span-4 gap-y-6 gap-x-4 md:grid-cols-6">
                ...
                <div class="col-span-3">
                  ...
                  <div class="grid gap-6 grid-col-1 md:grid-cols-2" style="
                      ...
                      border-style: solid;">
                    <ul>
                      <li v-for="(item, index) in packageLeft" :key="item.id" @click="moveToRight(item, index)">
                ...
                <div class="col-span-7">
                  ...
                  <div class="grid gap-6 grid-col-1 md:grid-cols-2" style="
                      ...
                      border-style: solid;">
                    <ul>
                      <li v-for="(item, index) in packageRight" :key="item.id" @click="moveToLeft(item, index)">
                        <div class="cursor-pointer">
                          {{ item.name }}
                        </div>
                      </li>
