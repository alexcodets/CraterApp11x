    ...
    <form v-if="!initLoad" @submit.prevent="submitPaymentAccountData">
      <sw-page-header class="mb-5" :title="pageTitle">
        <sw-breadcrumb slot="breadcrumbs">
          ...
          />
          <sw-breadcrumb-item
            v-if="$route.name === 'paymentAccountCustomer.view.CC' || $route.name === 'paymentAccountCustomer.create.ACH'"
            to="#"
...
export default {
  ...
  computed: {
    ...
    pageTitle() {
      if (this.$route.name === 'paymentAccountCustomer.edit.ACH' || this.$route.name === 'paymentAccountCustomer.edit.CC') {
