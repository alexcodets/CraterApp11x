 ...
 <div v-if="this.inclusive_minutes_cosumed != null">
          ...
          >
            <div>
              ...
              <sw-badge
                :bg-color="$utils.getBadgeStatusColor(backgroundCalculateStatus).bgColor"
                :color="$utils.getBadgeStatusColor(backgroundCalculateStatus).color"
              >
                {{ commandosDataJobs.calculate
                    ? 'Background Processing'
                    : 'None current background processess'
                }}
              </sw-badge>
            </div>
            <div>
              ...
              <sw-badge
                :bg-color="$utils.getBadgeStatusColor(backgroundImportStatus).bgColor"
            ...
            <div class="border-b tab">
              <div class="relative">
                ...
                <div class="tab-content-slide">
                  ...
                  <p><b>Prorate Date: </b> {{ row.date_prorate }}</p>
                  <p><b>Prorate Price: </b> {{ row.prorate/100  }}</p>
                </div>
                      </template>
                    </sw-table-column>
                  ...
                  >
                    ...
                    >
                      <template slot-scope="row">
                        ...
                        <sw-table-column
                      :sortable="true"
                      :label="$tc('pbx_services.tax_amount')"
                      show="taxamount"
                    >
                      <template slot-scope="row">
...
export default {
  ...
  methods: {
    ...
    async fetchExtensionsData({ page, filter, sort }) {
      ...
      console.log(response.data.response.service_extensions.data)
    ...
    async fetchDIDsData({ page, filter, sort }) {
      ...
      console.log(response.data.response.service_did.data)
    ...
    async fetchCallHistoryData({ page, filter, sort }) {
      ...
      console.log(response.data.response.totals)
    ...
    async fetchCustomDestinationData({ page, filter, sort }) {
      ...
      console.log(values.service_cdrs.data)
      return {
        ...
        if (response.data.totals) {
          if (response.data.totals) {
            if (response.data.totals.current) {
              ...
              this.prepaidtotalcurrenttax = response.data.totals.current.taxamount;
