    ...
    <form v-if="!initLoad" @submit.prevent="submitPaymentAccountData">
      <sw-page-header class="mb-5" :title="pageTitle">
        <sw-breadcrumb slot="breadcrumbs">
          ...
          />
          <sw-breadcrumb-item
            v-if="$route.name === 'customers.payment-account.create.CC' || $route.name === 'customers.payment-account.create.ACH'"
            to="#"
      ...
      <sw-card variant="customer-card">
        ...
        <div class="grid grid-cols-5 gap-4 mb-8">
          ...
          >
            ...
            <div
              class="flex items-center justify-start mb-6 md:mb-0"
            >
              <div class="p-1">
                <sw-button
                  ref="sameAddress"
        ...
        <div v-if="isCC || isEditCC" class="grid grid-cols-5 gap-4 mb-8">
          ...
          >
            ...
            <creditCardExpirationDate class="md:col-span-3"  v-model="formData.expiration_date" />
...
export default {
  ...
  computed: {
    ...
    pageTitle() {
      if (this.$route.name === 'customers.payment-account.edit.ACH' || this.$route.name === 'customers.payment-account.edit.CC') {
  ...
  methods: {
    ...
    async loadPaymentAccount() {
      ...
      this.formData.credit_cards = {'name': response.data.payment_accounts.credit_card, 'value': response.data.payment_accounts.credit_card};
    ...
    async copyAddress(val) {
      if (val === true) {
        ...
        this.formData.country_id = response.data.customer.billing_address.country_id
        ...
        this.formData.address_1 = response.data.customer.billing_address.address_street_1
        this.formData.address_2 = response.data.customer.billing_address.address_street_2
        ...
        let res = await window.axios.get('/api/v1/states/' + response.data.customer.billing_address.country.code)
        if (res) {
            ...
            swal({
              ...
              if (willDelete) {
                ...
                if (response.status === 200) {
                  this.$router.push(
                    `/admin/customers/${this.$route.params.id}/payment-accounts`
                  )
