...
<template>
  <div>
    <div class="col-span-12">
      ...
      >
        ...
        <div>
          ...
          <p class="text-sm font-bold leading-5 text-black non-italic">
            {{
              loggedInCustomer.customer &&
              loggedInCustomer.customer.currency
      ...
      <p
        v-if="getFormattedShippingAddress.length || getFormattedBillingAddress.length"
...
export default {
  ...
  computed: {
    ...
    getFormattedBillingAddress() {
      ...
      console.log(this.loggedInCustomer.customer.billing_address);
      ...
      if (this.loggedInCustomer.customer.billing_address.state) {
        billingAddress += `<span>${this.loggedInCustomer.customer.billing_address.state},</span>`
      }
    ...
    getFormattedShippingAddress() {
      ...
      if (
        this.loggedInCustomer.customer.shipping_address.address_street_1
      ) {
        shippingAddress += `<span>${this.loggedInCustomer.customer.shipping_address.address_street_1},</span><br>`
      }
      if (
        this.loggedInCustomer.customer.shipping_address.address_street_2
      ) {
