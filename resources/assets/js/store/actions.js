    ...
    return new Promise((resolve, reject) => {
      window.axios
        ...
        .then((response) => {
          ...
          commit(
            'company/' + companyTypes.SET_IDLE_TIME_LOGOUT,
            response.data.idle_time_logout
          )
          ...
          commit('company/' + companyTypes.SET_HEADER_COLOR, response.data.header_color)

          commit('user/' + userTypes.SET_PRIMARY_COLOR, response.data.primary_color)
