...
//fetchEstimates
export const fetchEstimatesCust = ({ commit, dispatch, state }, params) => {
  return new Promise((resolve, reject) => {
    window.axios
      .get(`/api/v1/estimates-customer`, { params })
      .then((response) => {
...
//fetchEstimate
export const fetchEstimateCust = ({ commit, dispatch, state }, id) => {
  return new Promise((resolve, reject) => {
    window.axios
...
//fetchViewEstimate
export const fetchViewEstimateCust = ({ commit, dispatch, state }, id) => {
  return new Promise((resolve, reject) => {
    window.axios
      .get(`/api/v1/estimates-customer/${id}`)
      .then((response) => {
...
export const searchEstimate = ({ commit, dispatch, state }, data) => {
  return new Promise((resolve, reject) => {
    window.axios
      .get(`/api/v1/estimates-customer?${data}`)
      .then((response) => {
        resolve(response)
      })
      .catch((err) => {
