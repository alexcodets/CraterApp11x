...
export default {
  ...
  [types.AVALARA_LOCATION_SAVED](state, data) {
    //console.log(data, "avalaraLocationSaved")
    state.avalaraLocationSaved = data
  },
  ...
  [types.SET_AVALARA_LOCATION_DATA](state, data) {
    state.avalaraLocationToSave = data
  },
