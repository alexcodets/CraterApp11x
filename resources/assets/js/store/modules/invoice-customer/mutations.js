...
export default {
  [types.SET_INVOICES_CUSTOMER](state, invoices) {
    state.invoices = invoices
  },

  [types.SET_TOTAL_INVOICES_CUSTOMER](state, totalInvoices) {
    state.totalInvoices = totalInvoices
  },

  [types.SET_INVOICES_ARCHIVED](state, archived) {
    state.archived = archived
  },

  [types.SET_TOTAL_INVOICES_ARCHIVED](state, totalArchived) {
    state.totalArchived = totalArchived
  },
  ...
  [types.UPDATE_ARCHIVED](state, data) {
    let pos = state.invoices.findIndex(
      (invoice) => invoice.id === data.invoice.id
    )
  ...
  [types.SET_TEMPLATE_ID_CUSTOMER](state, templateId) {
