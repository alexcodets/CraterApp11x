...
export const getUsersAdm = ({ commit, dispatch, state }) => {
  return new Promise((resolve, reject) => {
      window.axios.get(`/api/v1/users/users-admin`)
          .then((response) => {
              resolve(response)
          })
          .catch((err) => {
...
export const showUserId = ({ commit }, id) => {
  return new Promise((resolve, reject) => {
    window.axios
      .get(`/api/v1/users/show/${id}`)
      .then((response) => {
        resolve(response)
      })
      .catch((err) => {
...
export const updatePermissionsUser = ({ commit }, {id, permissions}) => {
  return new Promise((resolve, reject) => {
    window.axios
      .post(`/api/v1/users/update-permissions/${id}`, {permissions})
      .then((response) => {
        resolve(response)
      })
      .catch((err) => {
...
export const getStimatesAssignedUser = ({ commit }, params) => {
  return new Promise((resolve, reject) => {
    window.axios
      .get(`/api/v1/users/estimates-assigned/${params.id}`, {params})
      .then((response) => {
        resolve(response)
      })
      .catch((err) => {
