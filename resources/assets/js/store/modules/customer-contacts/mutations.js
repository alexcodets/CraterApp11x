...
export default {
  [types.CUSTOMER_CONTACT](state, customerAddress) {
    state.customerAddress = customerAddress
  },

  [types.SET_TOTAL_CUSTOMER_CONTACTS](state, totalCustomerContacts) {
    state.totalCustomerContacts = totalCustomerContacts
  },
...
*/
  [types.UPDATE_CUSTOMER_CONTACT](state, data) {
...
/*
  ...
  [types.SET_SELECTED_CUSTOMER_CONTACT](state, data) {
