...
export default {
  ...
  //
  [types.SET_PAYMENT_MODES_WITH_SETTINGS](state, data) {
    state.paymentModesWithSettings = data
  },
  [types.SET_EXIST_AUTHORIZE_SETTING](state, data) {
    state.existAuthorizeSetting = data
  },
  [types.SET_EXIST_PAYPAL_SETTING](state, data) {
    state.existPaypalSetting = data
  },
  [types.SET_EXIST_AUX_VAULT_SETTING](state, data) {
    state.existAuxVaultSetting = data
  },
  //
