...
export const fetchPaymentsCustomers = ({ commit, dispatch, state }, params) => {
    return new Promise((resolve, reject) => {
        window.axios
            .get(`/api/v1/payments-customer`, { params })
            .then((response) => {
...
export const fetchPaymentCustomers = ({ commit, dispatch }, id) => {
...
export const searchPayment = ({ commit, dispatch, state }, data) => {
    return new Promise((resolve, reject) => {
        window.axios
            .get(`/api/v1/payments-customer?${data}`)
            .then((response) => {
