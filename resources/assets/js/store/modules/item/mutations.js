...
export default {
  ...
  [types.BOOTSTRAP_ITEMS_POS](state, itemsPos) {
  ...
  [types.SET_TOTAL_ITEMS_POS](state, totalItemsPos) {
    state.totalItemsPos = totalItemsPos
  },
  ...
  [types.SET_ITEMS_CATEGORIES](state, categories) {
