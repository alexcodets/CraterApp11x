...
export default {
  ...
  data() {
    return {
      currentPbx: {
        link: '/admin/module/corePOS/configuration',
  ...
  created() {
    if (this.$route.path === '/admin/module/corePOS') {
      this.$router.push('/admin/module/corePOS/configuration')
    }
  },
