<template>
  <div class="fixed top-0 left-0 hidden h-full pt-16 pb-4 ml-56 bg-white xl:ml-64 w-64 xl:block">
      <div class="p-5">
        <sw-page-header :title="$tc('general.billpay', 1)">
...
export default {
  ...
  data() {
    return {
      currentPbx: {
        link: '/admin/module/billpay/configuration',
      ...
      menuItems: [
        ...
        {
          link: '/admin/module/billpay/messaging',
          title: 'general.messaging',
          icon: 'collection-icon',
        },
        {
          link: '/admin/module/billpay/logins',
          title: 'general.login',
          icon: 'collection-icon',
        },
        {
          link: '/admin/module/billpay/notifications_logs',
          title: 'general.notifications_logs',
          icon: 'collection-icon',
        },
  ...
  created() {
    if (this.$route.path === '/admin/module/billpay') {
      this.$router.push('/admin/module/billpay/configuration')
    }
  },
