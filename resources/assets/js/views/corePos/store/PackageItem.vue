      ...
      <table class="w-full">
        ...
        <tbody>
          <tr style="background-color: #f5f3f3;">
            <td class="px-5 py-4 text-left align-top">
              <div class="flex justify-start">
                ...
                <div v-if="isView">
                  <p class="text-sm font-bold leading-5 text-black non-italic" v-text="item.name"></p>
                </div>
                <item-select
                  v-else
                  ref="itemSelect"
          ...
          <tr v-if="taxPerItem === 'YES'" class="tax-tr">
            <!-- <td class="px-5 py-4 text-left align-top" /> -->
            <td colspan="12" class="align-top ">
              <tax
                v-for="(tax, index) in item.taxes"
                :key="tax.id"
                :disabled="item.no_taxable == 1 ? true : false"
                :index="index"
                :tax-data="tax"
                :taxes="item.taxes"
              ...
              <!-- <div>
                <div class="relative w-4">
                    <sw-checkbox
                        v-model="item.no_taxable"
                        class="absolute"
                    />
                </div>
                <div class="ml-6" style="margin-left: 50px;">
...
import ItemSelect from './PackageItemSelect'
import Tax from './Tax'
  ...
  methods: {
    updateTax(data) {
      ...
      if (lastTax.tax_type_id !== 0) {
        //console.log({ ...TaxStub, id: Guid.raw() })
