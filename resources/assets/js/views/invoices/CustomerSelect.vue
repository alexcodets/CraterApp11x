  ...
  <div class="col-span-5 pr-0">
    ...
    >
      <div class="relative flex justify-between mb-2">
        <router-link :to="{ path: `/admin/customers/${selectedCustomer.id}/view` }">
          {{ selectedCustomer.name }}
        </router-link>
        <div v-if="!isEditInvoice">
          <div v-if="!isAvalaraInvoiceActive">
            <a
      ...
      <div class="relative justify-between mb-1">
        <label class="text-sm">{{ selectedCustomer.customcode }}</label>
      </div>
    ...
    <div v-else>
      ...
      >
        ...
        <customer-select-popup :user-id="customerId" :avalara_bool="avalara_bool" type="invoice" />
      </sw-popup>
    </div>
  </div>
</template>
