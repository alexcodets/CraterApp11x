...
export default {
  ...
  methods: {
    ...
    async searchItems(search) {
      let data = {
        ...
        orderByField: '',
        orderBy: '',
        avalara_bool: this.avalaraIsTaxable,
        page: 1,
        limit: 1000
      }
    ...
    openItemModal() {      
      ...
      this.openModal({
        ...
        data: { taxPerItem: this.taxPerItem, taxes: this.taxes, retentionActive: this.retentionActive },
      })
    },
  ...
  created() {
    this.searchItems = _.debounce(this.searchItems, 800)
  },
}
</script>
