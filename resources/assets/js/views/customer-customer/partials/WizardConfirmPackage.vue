        ...
        <div class="mt-8">
          ...
          >
            ...
            <div>
              ...
              <p class="text-sm font-bold leading-5 text-black non-italic">
                {{ this.package ? this.package.name : '' }}
              </p>
            </div>
            <div>
              <p
          ...
          <div class="mt-8">
            <table class="w-full text-center item-table">
              ...
              <tbody>
                <tr
                  v-for="item in packageCustomer.items"
          ...
          >
            ...
            >
              ...
              <div v-if="taxPerItem ? 'NO' : null">
                <div
                  v-for="tax in packageCustomer.taxes"
...
export default {
  ...
  computed: {
    ...
    isView() {
      ...
      else */ if (this.$route.name === 'customer.package-view') {
        /* console.log("Mostrar",this.defaultCurrency) */
        return true
      }
      return false
    },
  ...
  methods: {
    ...
    async loadData() {
      ...
      if (this.isView) {
          // console.log('ALO',this.$route.params.customer_package_id)
