  ...
  <div class="fixed top-0 left-0 hidden h-full pt-16 pb-4 ml-56 bg-white xl:ml-64 w-88 xl:block">
      <div class="p-8">
        <sw-page-header :title="$tc('reports.reports_PBX')">
            ...
            />
            <sw-breadcrumb-item
                :title="$tc('tickets.menu_title.departaments_pbx')"
                to="#"
                active
            />
            </sw-breadcrumb>
...
export default {
  ...
  data() {
    return {
      currentPbx: {
        link: '/customer/reports/departaments',
        title: 'tickets.menu_title.departaments_pbx',
      ...
      menuItems: [
        ...
        {
          link: '/customer/reports/reports-pbx',
          title: 'reports.reports_PBX2',
          icon: 'collection-icon',
        }
