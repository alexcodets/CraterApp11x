  ...
  <div class="overflow-auto" style="height:85vh;">
    <div>
      ...
      <div class="px-8 py-8 sm:p-6">
        ...
        :fields="estimateMailFields"  required
          />
      </sw-input-group>
        <sw-input-group
...
export default {
  ...
  methods: {
    ...
    async setInitialData() {
      ...
      if (res.data.estimate_mail_subject) {
        if (res.data.estimate_mail_subject != null) {
          this.formData.subject = res.data.estimate_mail_subject
        }
      }
    },
    resetFormData() {
