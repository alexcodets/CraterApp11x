...
<table width="100%" class="items-table" cellspacing="0" border="0">
    <tr>
        <td class="item-table-title text-center" colspan="4">@lang('pdf_extensions_label')</td>
    </tr>
    <tr class="item-table-heading-row">
        <th width="50%" class="pl-0 text-left item-table-heading">@lang('pdf_name_label')</th>
        <th widht="1%" class="text-center item-table-heading">@lang('pdf_qty')</th>
        <th class="text-right item-table-heading">@lang('pdf_pro_ext_name_label')</th>
            ...
            <td
                ...
                <td
                    ...
                    >        
                        ...
                        <!--  
                        @if(array_key_exists('Price', $segundo_arr))
                            {!! format_money_pdf($invoice->pbx_extension_price * 100, $_currency) !!}                          
                        @endif--> 
                </td>                  
            </tr>
        @endforeach   
...
@if(isset($invoice_pbx_extension_detail) && $invoice->is_edited == 1)
