<table width="100%" class="items-table" cellspacing="0" border="0">
    <tr>
        <td class="item-table-title text-center" colspan="6">@lang('pdf_charges_label')</td>
    </tr>
    <tr class="item-table-heading-row">
        <th class=" text-left item-table-heading">@lang('pdf_name_label')</th>
        ...
        <th class="text-right item-table-heading">@lang('pdf_template_label')</th>
