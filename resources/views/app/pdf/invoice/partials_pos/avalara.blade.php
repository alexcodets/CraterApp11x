<table width="100%" class="items-table" cellspacing="0" border="0">
    <tr>
        <td class="item-table-title text-center" colspan="5">@lang('pdf_items_label')</td>
    </tr>
    <tr class="item-table-heading-row">
        <th width="1%" class="pr-20 text-right item-table-heading">#</th>
        <th width="20%" class="pl-0 text-left item-table-heading">@lang('pdf_items_label')</th>
        <th widht="1%" class=" text-right item-table-heading">@lang('pdf_qty')</th>
