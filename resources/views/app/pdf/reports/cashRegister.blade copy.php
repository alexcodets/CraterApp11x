...
<body>
                ...
                <td class="text-center">
                    <div class="box-details">
                        <div style="margin-bottom: 0px !important">
                            <span class="title-details">@lang('pdf_cash_register_company'):</span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_name'):</span>
                            <span>
                                {{ $company->name}}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_identification'):</span>
                            <span>
                                {{ $company->company_identifier}}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_address'):</span>
                            <span>
                                {{ $company->address->address_street_1}}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_city'):</span>
                            <span>
                                {{ $company->address->city}}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_county'):</span>
                            <span>
                                {{ $company->address->county}}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_phone'):</span>
                            <span>
        ...
        <table width="100%" style="margin: 0px 5px 0px 5px">
            <tr>
                ...
                <td class="text-center">
                    <div class="box-details">
                        <div style="margin-bottom: 0px !important">
                            <span class="title-details">@lang('pdf_cash_register_cash_register'):</span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_reference'):</span>
                            <span>
                                {{ $cash_history->ref }}
                            </span>
                        </div>
                        ...
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_description'):</span>
                            <span>
        ...
        <table width="100%" style="margin: 0px 5px 0px 5px">
            <tr>
                <td class="text-center">
                    <div class="box-details">
                        <div style="margin-bottom: 0px !important">
                            <span class="title-details">@lang('pdf_cash_register_period_cash_history'):</span>
                        </div>

                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_status'):</span>
                            @if($cash_history->open_cash == 1)
                            <span>@lang('pdf_cash_register_open')</span>
                            @else
                            <span>@lang('pdf_cash_register_close')</span>
                            @endif
                        ...
                        <div class="text-details" style="margin-bottom:0px;">
                            ...
                            <span>
                                {{ $cash_history->open_date }}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_close_date'):</span>
                            <span>
                                {{ $cash_history->close_date }}
                            </span>
                        </div>
    ...
    <div class="content-wrapper center-horizontal">
        <table width="90%">
            ...
            <tr>
                <td class="text-center">
                    <span class="title-details">@lang('pdf_cash_register_amount')</span>
                </td>
                <td class="text-center">
                    <span class="title-details">@lang('pdf_cash_register_method_name')</span>
                </td>
            </tr>
            @foreach($detail_sales as $sale)
            <tr>
                <td class="text-center text-details">
                    <div class="">
        ...
        <table width="100%" style="margin: 0px 5px 0px 5px">
            <tr>
                <td class="text-center">
                    ...
                    <hr>
                    @php
                        $total_income = $cash_history->initial_amount + ($cash_income / 100)+ ($invoices_amount->received / 100);
                        $total_expenses = ($cash_withdrawal / 100)+ ($invoices_amount->returned / 100);
                        
                        @endphp
                        <div class="text-details " style="margin-top:5px;">
                            <span>@lang('pdf_cash_register_income'):</span>
                            <span>
                                {!! format_money_pdf($total_income * 100) !!}
                            </span>
                        </div>
                        <div class="text-details" style="margin-bottom:0px;">
                            <span>@lang('pdf_cash_register_expenses'):</span>
                            <span>
