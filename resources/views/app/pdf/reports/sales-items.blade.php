...
<body>
    <div class="sub-container">
        ...
        @if ($paid_status_name != null || $customers_name != null || $users_name != null || $units_name != null || $categories_name != null || $groups_name != null || $items_name != null)
        <div class="styleFilter">
            ...
            @if ($customers_name != null)
                <p><b> Customers:</b> {{ $customers_name}}</p>
            @endif
            @if ($users_name != null)
                <p><b> Users:</b> {{ $users_name}}</p>
            @endif       
            @if ($units_name != null)
                <p><b> Units:</b> {{ $units_name}}</p>
            @endif
            @if ($categories_name != null)
                <p><b> Categories:</b> {{ $categories_name}}</p>
            @endif
            @if ($groups_name != null)
                <p><b> Groups:</b> {{ $groups_name}}</p>
            @endif
            @if ($items_name != null)
                <p><b> Items:</b> {{ $items_name}}</p>
            @endif
            <!-- / -->
        </div>
        @endif
